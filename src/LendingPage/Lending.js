...
import TopImage from "../assets/x1_bg.png";
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-6 col-md-6  ">
              ...
              <p className="home-body-text">
                The DAO Tool helps DAO manage their role based Team membership using NFTs, Payroll management, DAO Drive for document management and grant role based permissions to DAO members.
              </p>
          ...
          <div className="row">
            <div className="col-12 col-lg-6 text-center m-auto  ">
              <h1 className="section-header-text mt-4 " style={{ fontSize: "36px", fontWeight: "bold" }}>
                ...
                The <span style={{ color: "#6EBF8B" }}>DAO Tool </span> Covers
              </h1>
